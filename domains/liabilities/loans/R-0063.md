...
| Table | Role |
|---|---|
| `loan_register` | Primary metadata: name, description, lender_eca_id, original_amount, current_balance (derived — computed on read), interest_rate_annual_pct, compounding_frequency, repayment_frequency, repayment_amount, start_date, maturity_date, use_of_funds, business_use_pct, accrued_interest_balance, liability_account_id, accrued_interest_account_id, interest_expense_account_id, status, estimate_changes JSONB, correction_id, origination_transaction_id, payout_transaction_id, payout_date, written_off_transaction_id, written_off_date. |
